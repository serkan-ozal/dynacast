...
public class Dynacast {
    ...
    public static <K, V> DynaCastStorage<K, V> getStorage(String storageName) {
        return DynaCastStorageProvider.getStorage(storageName);
    }
    
    public static <K, V> DynaCastStorage<K, V> getOrCreateStorage(String storageName, DynaCastStorageType storageType) {
        return DynaCastStorageProvider.getOrCreateStorage(storageName, storageType);
    }
